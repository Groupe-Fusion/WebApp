...
export default function SignUp() {
  ...
  const onSubmit = async (data: SignUpFormData) => {
    ...
    try {
      ...
      // Simulation d'inscription réussie - à remplacer par votre logique
      console.log('Registration data:', data);
      
      // Redirection après inscription réussie
      navigate('/signin', { state: { message: 'Compte créé avec succès ! Vous pouvez maintenant vous connecter.' } });
    } catch (err) {
